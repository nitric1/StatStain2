...
--	statsColors.frostDamage		= ''
--	statsColors.natureDamage	= ''
--	statsColors.shadowDamage	= ''

--	statsColors.arcaneResist	= ''
--	statsColors.fireResist		= ''
--	statsColors.frostResist		= ''
--	statsColors.natureResist	= ''
--	statsColors.shadowResist	= ''

--	statsColors.redGem			= ''
--	statsColors.greenGem		= ''
--	statsColors.yellowGem		= ''
--	statsColors.orangeGem		= ''
--	statsColors.blueGem			= ''
--	statsColors.purpleGem		= ''
